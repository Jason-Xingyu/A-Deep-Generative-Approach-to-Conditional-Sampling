...
fitgcde.mnist.x34image.cnn <- function(train.x, train.y, test.x, test.y,
                                         load.gene = NULL,
                                         load.disc = NULL,
                                         diagnostic.info,
...
plot.whiletraining.mnist.x34image.cnn <- function(generator.t, ite, train.x = x_test, 
    ...
    #dir.create("training_plot/x34image")
    pdf(file = paste0("training_plot/x34image/mnist_x34image_cnn_ite=",ite, dual, ".pdf"), 
...
#30000ite on lr 0.0002 and 15000 on lr 0.0001



#Start of the training
gcde.mnist.ximagetquar.cnn <- fitgcde.mnist.x34image.cnn(x_train, y_train, x_test, y_test,
                                                          load.gene = "trained/mnist_x34image_cnn_fenchel_generator.h5",
                                                          load.disc = "trained/mnist_x34image_cnn_fenchel_discriminator.h5",
                                                          ...
                                                          lambda.mse         = 0,       
                                                          m                  = 1,
                                                          extra.function     = plot.whiletraining.mnist.x34image.cnn,
                                                          vanillaNN          = FALSE)
save_model_weights_hdf5(gcde.mnist.ximagetquar.cnn$generator, "trained/mnist_x34image_cnn_fenchel_generator.h5")
save_model_weights_hdf5(gcde.mnist.ximagetquar.cnn$discriminator, "trained/mnist_x34image_cnn_fenchel_discriminator.h5")



plot.whiletraining.mnist.x34image.cnn(gcde.mnist.ximagetquar.cnn$generator.t, "pic19", dual = "fenchel", pic.num = 19)

sapply(5:10, function(i) plot.whiletraining.mnist.x34image.cnn(
    gcde.mnist.ximagetquar.cnn$generator.t, paste0("pic",i), dual = "fenchel", pic.num = i))
...
gcde.mnist.x34image.cnn.primal <- fitgcde.mnist.x34image.cnn(x_train, y_train, x_test, y_test,
                                                             load.gene = "trained/mnist_x34image_cnn_primal_generator.h5",
                                                             load.disc = "trained/mnist_x34image_cnn_primal_discriminator.h5",
                                                             diagnostic.info    = NULL,
                                                             v.label            = "new",
                                                             kl.dual            = FALSE,
                                                             dual.form          = NULL,
                                                             ...
                                                             extra.function     = plot.whiletraining.mnist.x34image.cnn,
                                                             vanillaNN          = FALSE)
save_model_weights_hdf5(gcde.mnist.x34image.cnn.primal$generator, "trained/mnist_x34image_cnn_primal_generator.h5")
save_model_weights_hdf5(gcde.mnist.x34image.cnn.primal$discriminator, "trained/mnist_x34image_cnn_primal_discriminator.h5")


sapply(5:10, function(i) plot.whiletraining.mnist.x34image.cnn(
    gcde.mnist.x34image.cnn.primal$generator.t, paste0("pic",i), dual = "primal", pic.num = i))
